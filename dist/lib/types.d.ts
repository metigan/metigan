 ...
 */
export type ContactApiResponse = ContactSuccessResponse | ContactGetResponse | ContactUpdateResponse | ContactDeleteResponse | EmailErrorResponse | ApiKeyErrorResponse;
/**
 * Union type for all possible audience API responses
 */
export type AudienceApiResponse = AudienceCreateResponse | AudienceGetResponse | AudienceUpdateResponse | AudienceDeleteResponse | EmailErrorResponse | ApiKeyErrorResponse;
/**
